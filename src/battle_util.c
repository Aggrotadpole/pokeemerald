...
u32 AbilityBattleEffects(u32 caseID, u32 battler, u32 ability, u32 special, u32 moveArg)
{
    ...
    case ABILITYEFFECT_ON_SWITCHIN: // 0
        ...
        case ABILITY_MOLD_BREAKER:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates))
            {
        ...
        case ABILITY_CURIOUS_MEDICINE:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates) && IsDoubleBattle()
        ...
        case ABILITY_SCREEN_CLEANER:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates) && TryRemoveScreens(battler))
            {
        ...
        case ABILITY_DRIZZLE:
            ...
            else if (gBattleWeather & B_WEATHER_PRIMAL_ANY && WEATHER_HAS_EFFECT && (!gSpecialStatuses[battler].switchInAbilityDone || runInnates))
            {
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
        ...
        case ABILITY_INTREPID_SWORD:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates) && CompareStat(battler, STAT_ATK, MAX_STAT_STAGE, CMP_LESS_THAN))
            {
                gBattlerAttacker = battler;
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
        ...
        case ABILITY_DAUNTLESS_SHIELD:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates) && CompareStat(battler, STAT_DEF, MAX_STAT_STAGE, CMP_LESS_THAN))
            {
                gBattlerAttacker = battler;
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
        ...
        case ABILITY_SUPREME_OVERLORD:
            if ((!gSpecialStatuses[battler].switchInAbilityDone || runInnates) && CountUsablePartyMons(battler) < PARTY_SIZE)
            {
                gSpecialStatuses[battler].switchInAbilityDone = TRUE;
